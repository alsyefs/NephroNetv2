<%@ Page Title="Consultations" Language="C#" MasterPageFile="~/Physician.Master" AutoEventWireup="true" CodeBehind="MyTopics.aspx.cs" Inherits="NephroNet.Accounts.Physician.MyTopics" %>
            ...
            <div class="panel-body">
                ...
                <div id="table">
                    <asp:GridView ID="grdTopics" runat="server" Width="100%" HorizontalAlign="Center" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" PageSize="20" AllowPaging="True" OnPageIndexChanging="grdTopics_PageIndexChanging">
                        ...
                        <Columns>
                            <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="ViewTopic.aspx?id={0}" SortExpression="id" Text="Enter" />
                        </Columns>
