<%@ Page Title="Change your security questions and answers" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="ChangeSecurityQuestions.aspx.cs" Inherits="NephroNet.Accounts.Patient.ChangeSecurityQuestions" %>
