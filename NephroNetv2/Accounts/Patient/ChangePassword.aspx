<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="NephroNet.Accounts.Patient.ChangePassword" %>
