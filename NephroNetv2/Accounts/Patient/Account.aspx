<%@ Page Title="Account" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="Account.aspx.cs" Inherits="NephroNet.Accounts.Patient.Account" %>
