<%@ Page Title="Approve Topics" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ApproveTopics.aspx.cs" Inherits="NephroNet.Accounts.Admin.ApproveTopics" %>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <asp:GridView ID="grdTopics" runat="server" Width="100%" HorizontalAlign="Center" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" PageSize="20" AllowPaging="True" OnPageIndexChanging="grdTopics_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="~/Accounts/Admin/ReviewTopic.aspx?id={0}" SortExpression="id" Text="Review" />
                    </Columns>
